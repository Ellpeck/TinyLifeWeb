...
You can find all the info [on the fundraiser's page](https://outrightinternational.org/familypride), with regular updates also being posted [on Twitter](https://x.com/TinyLifeGame) as well as [the Discord](https://link.tinylifegame.com/discord).
