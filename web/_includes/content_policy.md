*Please read this document carefully before creating posts or content related to Tiny Life. By sharing content on any of the officially supported platforms, you also agree that you have read all the information below.*
...
- ❌ You are not allowed to share mods created entirely or substantially with generative artificial intelligence (**GenAI**) or large language models (**LLMs**). This includes code, documentation, and assets. GenAI may only be used for the purpose of understanding the game's API and its documentation or for user-reviewed debugging assistance, provided that the results are thoroughly reviewed and any suggestions are manually implemented.
